...
def test_field_value_convert():
    ...
    # path, not fit
    assert (("a%s" % KEYWORD_BK_IAM_PATH_FIELD_SUFFIX, "b")
            == field_value_convert(OP.STARTS_WITH, "a%s" % KEYWORD_BK_IAM_PATH_FIELD_SUFFIX, "b"))
    assert (("a%s" % KEYWORD_BK_IAM_PATH_FIELD_SUFFIX, "/biz,1/set,2/")
            == field_value_convert(OP.STARTS_WITH, "a%s" % KEYWORD_BK_IAM_PATH_FIELD_SUFFIX, "/biz,1/set,2/"))

    # path, fit
    assert (("a%s" % KEYWORD_BK_IAM_PATH_FIELD_SUFFIX, "/biz,1/set,")
            == field_value_convert(OP.STARTS_WITH, "a%s" % KEYWORD_BK_IAM_PATH_FIELD_SUFFIX, "/biz,1/set,*/"))
